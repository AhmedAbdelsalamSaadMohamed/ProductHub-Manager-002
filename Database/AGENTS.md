...
- Never use COMMIT inside reusable procedures unless required by the documented transaction design.
...
- Keep transaction control at the calling-service layer unless documented otherwise.

...
CREATE OR REPLACE PACKAGE BODY ph_erp_management_pkg AS
    ...
    PROCEDURE raise_when_invalid(p_is_valid IN NUMBER, p_validation_message IN VARCHAR2);
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Platform updated successfully.', '�� ����� ������ �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Platform deactivated successfully.', '�� ����� ������ �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Pricing unit updated successfully.', '�� ����� ���� ������� �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Pricing unit deactivated successfully.', '�� ����� ���� ������� �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Payment cycle updated successfully.', '�� ����� ���� ����� �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Payment cycle deactivated successfully.', '�� ����� ���� ����� �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Product updated successfully.', '�� ����� ������ �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Product and related catalog entries deactivated successfully.', '�� ����� ������ ������ �������� �������� �� �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Module updated successfully.', '�� ����� ������ �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Module and related platforms/features deactivated successfully.', '�� ����� ������ �������� �������� �������� ��� �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Module platform updated successfully.', '�� ����� ���� ������ �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Module platform and related features deactivated successfully.', '�� ����� ���� ������ �������� �������� ��� �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Feature updated successfully.', '�� ����� ������ �����.');
    ...
    BEGIN
        ...
        p_message := ph_localization_pkg.localized_text('Feature deactivated successfully.', '�� ����� ������ �����.');
    ...
    BEGIN
        ...
        set_success(p_result_code, p_result_message, ph_localization_pkg.localized_text('Platform created successfully.', '�� ����� ������ �����.'));

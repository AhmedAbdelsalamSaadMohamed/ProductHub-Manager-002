...
PROMPT Creating ERP product error log package...
@"packages/02_ph_erp_product_error_log_pkg.sql"

PROMPT Creating ERP LOV package...
@"packages/02_ph_erp_lov_pkg.sql"

/*
ProductHub Manager - Security Error Log Package
Target DBMS: Oracle Database 21c+
*/

CREATE OR REPLACE PACKAGE ph_sec_error_log_pkg AS
    PROCEDURE log_error (
...
END ph_sec_error_log_pkg;
/

CREATE OR REPLACE PACKAGE BODY ph_sec_error_log_pkg AS
    PROCEDURE log_error (
        p_program_unit            IN VARCHAR2,
        p_program_unit_parameters IN CLOB DEFAULT NULL,
        p_error_location          IN VARCHAR2 DEFAULT NULL,
